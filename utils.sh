...
APP_NAME="${APP_NAME:-Director-Code}"
APP_NAME_LC="$( echo "${APP_NAME}" | awk '{print tolower($0)}' )"
ASSETS_REPOSITORY="${ASSETS_REPOSITORY:-daxijiu/Director-Code}"
BINARY_NAME="${BINARY_NAME:-director-code}"
GH_REPO_PATH="${GH_REPO_PATH:-daxijiu/Director-Code}"
ORG_NAME="${ORG_NAME:-Director-Code}"
